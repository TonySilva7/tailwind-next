...
function TabItem({ value, title, isSelected }: TabItemProps) {
  return (
    <Tabs.Trigger
      ...
      value={value}
    >
      <span className="whitespace-nowrap rounded group-focus-visible:border-violet-400 group-focus-visible:ring-2 group-focus-visible:ring-violet-400 group-focus-visible:ring-offset-4">
        {title}
      </span>
